...
export const FORMULAS: FormulaEntry[] = [
  ...
  },
  {
    ...
    example: {
      description: 'Mineralwolle WLG 035 (λ = 0,035 W/(mK)), d = 160 mm, ΔT = 30 K (innen 20 °C / außen −10 °C)',
      result: '6,6',
      unit: 'W/m²',
    },
    norm: 'DIN EN ISO 6946',
  ...
  },
  {
    ...
    example: {
      description: 'Innenraum 20 °C, 50 % rel. Luftfeuchte (Kastanienallee 7, Normalbetrieb)',
      result: '9,3',
      unit: '°C',
    },
    norm: 'DIN 4108-2',
  ...
  },
  {
    ...
    example: {
      description: 'Kastanienallee 7: K = 2.400.000 €, Honorarzone III, LP 1–9 (Mittelwertsatz)',
      result: '≈ 220.000',
      unit: '€',
    },
