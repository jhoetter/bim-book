...
Ein Gebäude kann warm, trocken und standsicher sein und trotzdem schlecht funktionieren, wenn man jeden Schritt, jede Leitung und jedes Gespräch hört. Schallschutz ist Alltagstauglichkeit. Er entscheidet, ob Nähe im Mehrfamilienhaus akzeptabel bleibt.
...
type: diagram
size: landscape
desc: Grundriss-Ausschnitt zweier benachbarter Wohnungen mit direktem Schallpfad durch Trennwand und flankierenden Schallpfaden über Decke, Außenwand und Installationsschacht. Pfeile farblich unterschieden, deutsche Labels, weißer Hintergrund.
caption: Schall wandert direkt und über flankierende Bauteile
tags: schallschutz, luftschall, flankenübertragung, grundriss
-->
...
Installationsschächte müssen schalltechnisch entkoppelt und ausreichend schwer bekleidet werden. Abwasserleitungen erzeugen Körperschall, besonders bei Fallleitungen. Pumpen und Lüftungsgeräte brauchen elastische Lager und flexible Anschlüsse.

<!-- IMAGE
name: kap08_deckenaufbau_schall
type: section
size: portrait
desc: Querschnitt einer Wohnungstrenndecke mit Stahlbetondecke, Trittschalldämmung, Randdämmstreifen, schwimmendem Estrich und Bodenbelag. Schallpfade und Entkopplungsschichten farbig markiert, deutsche Beschriftung, weißer Hintergrund.
caption: Trittschalldämmung wirkt nur, wenn der Estrich wirklich schwimmt
tags: schallschutz, trittschall, estrich, deckenaufbau
-->
![Schallschutz im Deckenaufbau](../assets/illustrations/kap08_deckenaufbau_schall.png)
...
Ähnlich kritisch sind Installationen. Eine Fallleitung neben einem Schlafzimmer ist nicht automatisch falsch, aber sie braucht Masse, Entkopplung, schallgedämmte Rohrschellen und eine geeignete Schachtwand. Wird der Schacht aus Platzgründen dünner gebaut oder mit Revisionsöffnungen geschwächt, kann die akustische Planung kippen. Für Grundrisse heißt das: Nassräume sollten gebündelt und von besonders schutzbedürftigen Räumen getrennt werden, soweit es die Wohnqualität erlaubt.

Der Aufzug ist ein weiterer Sonderfall. Er erzeugt Körperschall über Führungen, Antrieb, Türen und Bremsvorgänge. Ein Aufzugsschacht direkt an Wohn- oder Schlafräumen braucht deshalb besondere Aufmerksamkeit: schwere Schachtwände, elastische Lagerung von Komponenten und sorgfältige Türbereiche. Beim Leitbeispiel liegt der Aufzug im Treppenhauskern; das ist funktional sinnvoll, muss aber akustisch gegenüber Wohnungen betrachtet werden.
...
Trotzdem kann ein Modell viel leisten. Es kann erkennen, welche Räume aneinandergrenzen, welche Nutzungen laut oder schutzbedürftig sind und welche Bauteile dazwischen liegen. Es kann Schachtlagen neben Schlafräumen markieren, Aufzugsschächte identifizieren, Trennbauteile ohne akustische Eigenschaft melden und Estrichflächen auf durchgehende Grenzen prüfen. Das ist noch keine akustische Berechnung, aber ein guter Qualitätsfilter.

Für Entwickler ist außerdem wichtig, dass dB-Werte logarithmisch sind. Man kann Schallschutzwerte nicht einfach addieren wie Längen oder Flächen. Eine Verbesserung um 3 dB ist physikalisch relevant, wird aber subjektiv nicht als doppelt so leise empfunden. Eine Softwareoberfläche sollte deshalb nicht nur Zahlen anzeigen, sondern die Bedeutung einordnen: Mindestanforderung, erhöhter Schutz, kritischer Bereich.

In BIM-Projekten ist eine akustische Anforderungsliste oft wertvoller als ein spätes Gutachten im PDF. Wenn Räume Nutzungscodes tragen und Bauteile akustische Zielwerte haben, kann die Koordination früh beginnen. Der Fachplaner bleibt verantwortlich, aber die digitale Struktur verhindert, dass Anforderungen erst nach fertiger Planung entdeckt werden.

## BIM-Brücke: Akustische Anforderungen als Properties

Akustische Anforderungen können im Modell als Properties geführt werden, etwa `Pset_WallCommon.AcousticRating` oder projektspezifische Raumvorgaben an `IfcSpace`. Ein Prüfwerkzeug kann dann fragen: Hat jede Wohnungstrennwand eine Schallschutzanforderung? Sind Schächte neben Schlafräumen markiert? Die eigentliche Berechnung bleibt fachlich, aber die Datenstruktur hilft bei Koordination.
