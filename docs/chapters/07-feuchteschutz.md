...
Feuchte Schäden beginnen selten spektakulär. Erst riecht ein Raum muffig, dann verfärbt sich eine Ecke, später löst sich Putz oder Holz wird weich. Wenn Feuchte im Bauteil bleibt, verliert ein Gebäude langsam seine Sicherheit.

---

!!! ziel "Nach diesem Kapitel können Sie …"
    - Diffusion und Konvektion als Feuchtewege unterscheiden
...
Der sd-Wert beschreibt die diffusionsäquivalente Luftschichtdicke. Ein hoher sd-Wert bedeutet: Wasserdampf kommt schwer hindurch. Eine ::Dampfbremse:: verlangsamt Diffusion, eine ::Dampfsperre:: blockiert sie weitgehend. Entscheidend ist nicht nur der Wert, sondern die Lage der Schicht und ihre luftdichte Ausführung.
...
Das Verfahren ist stark vereinfacht. Es betrachtet stationäre Winter- und Sommerbedingungen, aber keine kapillare Feuchte, Schlagregenaufnahme, Sorption oder feuchteadaptive Materialien. Trotzdem ist es didaktisch wertvoll: Es zeigt, warum warme Luft mehr Wasser halten kann als kalte und warum die Lage von Dämmschichten entscheidend ist.

Nach DIN 4108-3 darf in bestimmten Fällen begrenztes Tauwasser anfallen, wenn es in der Trocknungsperiode wieder verdunstet. Als Größenordnung werden oft 500 g/m² je Winter genannt, abhängig vom Bauteil. Besser ist ein Aufbau, der rechnerisch tauwasserfrei oder hygrothermisch robust ist.

<!-- IMAGE
name: kap07_glaser
type: diagram
size: landscape
desc: Diagramm des Glaser-Verfahrens durch eine Außenwand im Winter. Links Schichtaufbau, rechts Temperaturkurve, Sättigungsdampfdruck und Dampfdruckverlauf, mögliche Kondensationszone markiert. Deutsche Beschriftung, weißer Hintergrund, technisch-clean.
caption: Das Glaser-Verfahren vergleicht Dampfdruck und Sättigungsdruck im Bauteil
tags: glaser-verfahren, tauwasser, diffusion, feuchteschutz
-->
![Glaser-Verfahren](../assets/illustrations/kap07_glaser.png)
...
Eine ::Dampfsperre:: hat einen sehr hohen sd-Wert. Sie wird dort eingesetzt, wo Dampfdurchgang praktisch verhindert werden muss, etwa bei bestimmten Flachdachaufbauten oder hoch feuchtebelasteten Räumen. Sie ist aber nur so gut wie ihre Anschlüsse. Eine beschädigte Sperre ist gefährlich, weil sie Feuchte lokal hineinlässt und Trocknung behindern kann.
...
Als kritische Oberflächentemperatur wird häufig etwa 12,6 °C bei 20 °C Raumluft und 50 Prozent relativer Feuchte genannt. Diese Zahl ist kein Komfortziel, sondern eine Untergrenze zur Schimmelvermeidung. Gute Planung hält Innenoberflächen deutlich wärmer, vermeidet Möbel direkt an kalten Außenwänden und sichert Lüftung.
...
Flachdächer brauchen eine dauerhaft dichte Abdichtung, Gefälle und sichere Anschlüsse. Erdberührte Bauteile brauchen Schutzlagen und Perimeterdämmung. Nassräume brauchen Verbundabdichtungen unter Fliesen. In allen Fällen gilt: Abdichtung ist eine Ebene. Sie muss durchgehend sein und an Durchdringungen gelöst werden.

<!-- IMAGE
name: kap07_abdichtung_keller
type: section
size: portrait
desc: Kellerwand-Schnitt mit WU-Beton, Fugenband, XPS-Perimeterdämmung, Schutzlage, Drainageleitung, Filtervlies, Bodenplatte und Gelände. Wasserpfeile und Abdichtungsebene markiert, deutsche Labels, weißer Hintergrund.
caption: Kellerabdichtung verbindet Beton, Fugen, Dämmung und Wasserführung
tags: abdichtung, keller, weiße-wanne, perimeterdämmung
-->
![Kellerabdichtung](../assets/illustrations/kap07_abdichtung_keller.png)
...
Ein gutes Detail lässt sich mit dem Finger verfolgen. Die luftdichte Ebene muss ohne Unterbrechung durchlaufen. Die wasserführende Ebene muss Gefälle, Überdeckung und Anschlusshöhen haben. Die Dämmebene muss so geführt werden, dass keine kalten Innenoberflächen entstehen. Wenn eine dieser Linien im Detail verschwindet, ist das ein Warnsignal. CAD-Details werden deshalb nicht gezeichnet, um hübsch auszusehen, sondern um diese Linien zu prüfen.
...
Bei jedem Detail lohnt sich die Frage nach der Fehlertoleranz. Ein Aufbau, der nur funktioniert, wenn jede Foliennaht perfekt und dauerhaft dicht bleibt, ist riskanter als ein Aufbau mit Trocknungsreserve. Eine Konstruktion, die kleine Ausführungstoleranzen verkraftet, ist in der Praxis oft besser als eine rechnerisch brillante, aber empfindliche Lösung. Das gilt besonders bei Holzbau, Innendämmung und Flachdach.

Auch Bauablauf gehört zum Feuchteschutz. Dämmung, Holzbauteile und Estrich dürfen nicht dauerhaft nass eingebaut oder eingeschlossen werden. Ein dichter Neubau kann während der Bauphase enorme Feuchtemengen enthalten. Ohne Bautrocknung, Lüftung und Feuchtemessung werden Bodenbeläge, Beschichtungen und Holzbauteile zu früh geschlossen. Dann entsteht ein Schaden, obwohl der geplante Aufbau theoretisch korrekt war.
...
Sinnvoll sind deshalb Schichten mit Rollen. Eine Materialschicht kann tragend, dämmend, abdichtend, luftdichtend, dampfbremsend oder schützend sein. Diese Rollen sind nicht immer exklusiv. WU-Beton kann tragend und abdichtend wirken; eine Folie kann luftdicht und dampfbremsend sein; eine Putzlage kann Witterungsschutz und Oberfläche sein. Software muss solche Mehrfachrollen zulassen.

Auch Unsicherheit sollte modelliert werden. Bei Bestandsgebäuden ist oft nicht bekannt, ob eine Dampfbremse vorhanden oder intakt ist. Ein Prüfwerkzeug sollte zwischen "nicht vorhanden", "nicht gepflegt" und "unbekannt" unterscheiden. Diese Unterscheidung klingt klein, ist aber fachlich entscheidend: fehlende Daten sind kein Nachweis für fehlende Bauteile.

Die beste digitale Unterstützung liegt daher nicht in automatischer Feuchtesimulation für jedes Detail, sondern in Datenvollständigkeit und Risikoflaggen. Wenn ein Dachaufbau keine luftdichte Ebene hat, ein Nassraum keine Abdichtung, eine Innendämmung keine feuchtetechnische Prüfung oder ein Fensteranschluss keine Detailreferenz, sollte das Modell früh warnen.

## BIM-Brücke: Feuchte als Schichtinformation

Feuchtesimulation braucht Geometrie und Materialkennwerte. In IFC kann die Lage einer ::Dampfbremse:: oder ::Dampfsperre:: über `IfcMaterialLayerSet` dokumentiert werden; projektspezifische Properties können angeben, ob eine Schicht als luftdichte Ebene oder Dampfbremse wirkt. Für echte Simulation reicht das oft noch nicht, aber es schafft die Datenbasis.

## Zusammenfassung

**Feuchteschutz bedeutet, Wasserwege zu verstehen und Trocknungsmöglichkeiten zu sichern.**
