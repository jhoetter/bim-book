...
!!! ziel "Nach diesem Kapitel können Sie …"
    ...
    - Lebenszyklusanalyse und EPDs als Datengrundlage erklären
...
Eine Lebenszyklusanalyse betrachtet Phasen: A1-A3 Herstellung, A4-A5 Transport und Bau, B1-B7 Nutzung, C1-C4 Rückbau und Entsorgung, D mögliche Gutschriften durch Wiederverwendung. Die Systemgrenze muss klar sein: cradle-to-gate, cradle-to-grave oder cradle-to-cradle.
...
Nachhaltigkeitsdaten brauchen außerdem Zeitbezug. Ein Bauteil mit hoher Anfangsemission kann langlebig sein; ein leichteres Bauteil kann häufiger ersetzt werden. PV-Anlagen erzeugen im Betrieb Nutzen, haben aber Herstellungsemissionen. Dämmstoffe sparen Energie, verursachen aber Materialaufwand. Gute LCA-Tools zeigen deshalb Lebenszyklusphasen getrennt und machen Annahmen sichtbar, statt nur eine Endsumme zu präsentieren.
